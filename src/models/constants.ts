...
export const MODELS: Model[] = [
  // === OPENROUTER FREE TIER ===
  {
    ...
    description: "OpenAI's powerful open-source model via OpenRouter - fast and free",
    maxTokens: 131072,
    pricePer1kTokens: 0,
    capabilities: [
  ...
  },
  {
    ...
    name: "Google 31B",
    provider: ModelProvider.OPENROUTER,
    description: "Google's Gemma 4 31B via OpenRouter - free",
    maxTokens: 262144,
    pricePer1kTokens: 0,
  ...
  },
  {
    ...
    name: "Liquid 2.6B",
    provider: ModelProvider.OPENROUTER,
    description: "Liquid's model via OpenRouter - free",
    maxTokens: 131072,
    pricePer1kTokens: 0,
    capabilities: [ModelCapability.TEXT, ModelCapability.CODE],
    isAvailable: true,
